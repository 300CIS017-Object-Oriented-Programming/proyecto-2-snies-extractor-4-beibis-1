...
// Inicialización de las variables estáticas fuera de la clase.
  ...
  const std::string Settings::GRADUADOS_FILE_PATH = Settings::BASE_PATH + "graduados";
  const std::string Settings::MATRICULADOS_FILE_PATH = Settings::BASE_PATH + "matriculados";
  const std::string Settings::MATRICULADOS_PRIMER_SEMESTRE_FILE_PATH = Settings::BASE_PATH + "matriculadosPrimerSemestre";
